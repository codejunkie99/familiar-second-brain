...
| Resurface useful notes | `resurface.py` | `Daily/Resurfaced/YYYY-MM-DD Resurfaced Notes.md` |
...
```bash
cd /Users/username/Downloads/familiar-second-brain
...
familiar-second-brain/
  ...
  kimi_skill/
    ...
    scripts/
      ...
      resurface.py                # recurring useful-note resurfacing
    tests/
  scripts/
